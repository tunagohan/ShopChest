...
//            itemNames.add(new ItemName(Material.valueOf("GRASS_PATH"), langConfig.getString("block.minecraft.grass_path", "Grass Path")));
        ...
        if (Utils.getMajorVersion() >= 17) {
            itemNames.add(new ItemName(Material.AMETHYST_BLOCK, langConfig.getString("item.minecraft.amethyst_block", "Amethyst Block}")));
            itemNames.add(new ItemName(Material.AMETHYST_CLUSTER, langConfig.getString("item.minecraft.amethyst_cluster", "Amethyst Cluster}")));
            itemNames.add(new ItemName(Material.AMETHYST_SHARD, langConfig.getString("item.minecraft.amethyst_shard", "Amethyst Shard}")));
            itemNames.add(new ItemName(Material.AXOLOTL_BUCKET, langConfig.getString("item.minecraft.axolotl_bucket", "Axolotl Bucket}")));
            ...
            itemNames.add(new ItemName(Material.AZALEA, langConfig.getString("item.minecraft.azalea", "Azalea}")));
            itemNames.add(new ItemName(Material.AZALEA_LEAVES, langConfig.getString("item.minecraft.azalea_leaves", "Azalea Leaves}")));
            itemNames.add(new ItemName(Material.BIG_DRIPLEAF, langConfig.getString("item.minecraft.big_dripleaf", "Big Dripleaf}")));
            itemNames.add(new ItemName(Material.BIG_DRIPLEAF_STEM, langConfig.getString("item.minecraft.big_dripleaf_stem", "Big Dripleaf Stem}")));
            itemNames.add(new ItemName(Material.BLACK_CANDLE, langConfig.getString("item.minecraft.black_candle", "Black Candle}")));
            itemNames.add(new ItemName(Material.BLACK_CANDLE_CAKE, langConfig.getString("item.minecraft.black_candle_cake", "Black Candle Cake}")));
            itemNames.add(new ItemName(Material.BLUE_CANDLE, langConfig.getString("item.minecraft.blue_candle", "Blue Candle}")));
            itemNames.add(new ItemName(Material.BLUE_CANDLE_CAKE, langConfig.getString("item.minecraft.blue_candle_cake", "Blue Candle Cake}")));
            itemNames.add(new ItemName(Material.BROWN_CANDLE, langConfig.getString("item.minecraft.brown_candle", "Brown Candle}")));
            itemNames.add(new ItemName(Material.BROWN_CANDLE_CAKE, langConfig.getString("item.minecraft.brown_candle_cake", "Brown Candle Cake}")));
            itemNames.add(new ItemName(Material.BUDDING_AMETHYST, langConfig.getString("item.minecraft.budding_amethyst", "Budding Amethyst}")));
            itemNames.add(new ItemName(Material.BUNDLE, langConfig.getString("item.minecraft.bundle", "Bundle}")));
            itemNames.add(new ItemName(Material.CALCITE, langConfig.getString("item.minecraft.calcite", "Calcite}")));
            itemNames.add(new ItemName(Material.CANDLE, langConfig.getString("item.minecraft.candle", "Candle}")));
            itemNames.add(new ItemName(Material.CANDLE_CAKE, langConfig.getString("item.minecraft.candle_cake", "Candle Cake}")));
            itemNames.add(new ItemName(Material.CAVE_VINES, langConfig.getString("item.minecraft.cave_vines", "Cave Vines}")));
            itemNames.add(new ItemName(Material.CAVE_VINES_PLANT, langConfig.getString("item.minecraft.cave_vines_plant", "Cave Vines Plant}")));
            itemNames.add(new ItemName(Material.CHISELED_DEEPSLATE, langConfig.getString("item.minecraft.chiseled_deepslate", "Chiseled Deepslate}")));
            itemNames.add(new ItemName(Material.COBBLED_DEEPSLATE, langConfig.getString("item.minecraft.cobbled_deepslate", "Cobbled Deepslate}")));
            itemNames.add(new ItemName(Material.COBBLED_DEEPSLATE_SLAB, langConfig.getString("item.minecraft.cobbled_deepslate_slab", "Cobbled Deepslate Slab}")));
            itemNames.add(new ItemName(Material.COBBLED_DEEPSLATE_STAIRS, langConfig.getString("item.minecraft.cobbled_deepslate_stairs", "Cobbled Deepslate Stairs}")));
            itemNames.add(new ItemName(Material.COBBLED_DEEPSLATE_WALL, langConfig.getString("item.minecraft.cobbled_deepslate_wall", "Cobbled Deepslate Wall}")));
            itemNames.add(new ItemName(Material.COPPER_BLOCK, langConfig.getString("item.minecraft.copper_block", "Copper Block}")));
            itemNames.add(new ItemName(Material.COPPER_INGOT, langConfig.getString("item.minecraft.copper_ingot", "Copper Ingot}")));
            itemNames.add(new ItemName(Material.COPPER_ORE, langConfig.getString("item.minecraft.copper_ore", "Copper Ore}")));
            itemNames.add(new ItemName(Material.CRACKED_DEEPSLATE_BRICKS, langConfig.getString("item.minecraft.cracked_deepslate_bricks", "Cracked Deepslate Bricks}")));
            itemNames.add(new ItemName(Material.CRACKED_DEEPSLATE_TILES, langConfig.getString("item.minecraft.cracked_deepslate_tiles", "Cracked Deepslate Tiles}")));
            itemNames.add(new ItemName(Material.CUT_COPPER, langConfig.getString("item.minecraft.cut_copper", "Cut Copper}")));
            itemNames.add(new ItemName(Material.CUT_COPPER_SLAB, langConfig.getString("item.minecraft.cut_copper_slab", "Cut Copper Slab}")));
            itemNames.add(new ItemName(Material.CUT_COPPER_STAIRS, langConfig.getString("item.minecraft.cut_copper_stairs", "Cut Copper Stairs}")));
            itemNames.add(new ItemName(Material.CYAN_CANDLE, langConfig.getString("item.minecraft.cyan_candle", "Cyan Candle}")));
            itemNames.add(new ItemName(Material.CYAN_CANDLE_CAKE, langConfig.getString("item.minecraft.cyan_candle_cake", "Cyan Candle Cake}")));
            itemNames.add(new ItemName(Material.DEEPSLATE, langConfig.getString("item.minecraft.deepslate", "Deepslate}")));
            itemNames.add(new ItemName(Material.DEEPSLATE_BRICK_SLAB, langConfig.getString("item.minecraft.deepslate_brick_slab", "Deepslate Brick Slab}")));
            itemNames.add(new ItemName(Material.DEEPSLATE_BRICK_STAIRS, langConfig.getString("item.minecraft.deepslate_brick_stairs", "Deepslate Brick Stairs}")));
            itemNames.add(new ItemName(Material.DEEPSLATE_BRICK_WALL, langConfig.getString("item.minecraft.deepslate_brick_wall", "Deepslate Brick Wall}")));
            itemNames.add(new ItemName(Material.DEEPSLATE_BRICKS, langConfig.getString("item.minecraft.deepslate_bricks", "Deepslate Bricks}")));
            itemNames.add(new ItemName(Material.DEEPSLATE_COAL_ORE, langConfig.getString("item.minecraft.deepslate_coal_ore", "Deepslate Coal Ore}")));
            itemNames.add(new ItemName(Material.DEEPSLATE_COPPER_ORE, langConfig.getString("item.minecraft.deepslate_copper_ore", "Deepslate Copper Ore}")));
            itemNames.add(new ItemName(Material.DEEPSLATE_DIAMOND_ORE, langConfig.getString("item.minecraft.deepslate_diamond_ore", "Deepslate Diamond Ore}")));
            itemNames.add(new ItemName(Material.DEEPSLATE_EMERALD_ORE, langConfig.getString("item.minecraft.deepslate_emerald_ore", "Deepslate Emerald Ore}")));
            itemNames.add(new ItemName(Material.DEEPSLATE_GOLD_ORE, langConfig.getString("item.minecraft.deepslate_gold_ore", "Deepslate Gold Ore}")));
            itemNames.add(new ItemName(Material.DEEPSLATE_IRON_ORE, langConfig.getString("item.minecraft.deepslate_iron_ore", "Deepslate Iron Ore}")));
            itemNames.add(new ItemName(Material.DEEPSLATE_LAPIS_ORE, langConfig.getString("item.minecraft.deepslate_lapis_ore", "Deepslate Lapis Ore}")));
            itemNames.add(new ItemName(Material.DEEPSLATE_REDSTONE_ORE, langConfig.getString("item.minecraft.deepslate_redstone_ore", "Deepslate Redstone Ore}")));
            itemNames.add(new ItemName(Material.DEEPSLATE_TILE_SLAB, langConfig.getString("item.minecraft.deepslate_tile_slab", "Deepslate Tile Slab}")));
            itemNames.add(new ItemName(Material.DEEPSLATE_TILE_STAIRS, langConfig.getString("item.minecraft.deepslate_tile_stairs", "Deepslate Tile Stairs}")));
            itemNames.add(new ItemName(Material.DEEPSLATE_TILE_WALL, langConfig.getString("item.minecraft.deepslate_tile_wall", "Deepslate Tile Wall}")));
            itemNames.add(new ItemName(Material.DEEPSLATE_TILES, langConfig.getString("item.minecraft.deepslate_tiles", "Deepslate Tiles}")));
            itemNames.add(new ItemName(Material.DIRT_PATH, langConfig.getString("item.minecraft.dirt_path", "Dirt Path}")));
            itemNames.add(new ItemName(Material.DRIPSTONE_BLOCK, langConfig.getString("item.minecraft.dripstone_block", "Dripstone Block}")));
            itemNames.add(new ItemName(Material.EXPOSED_COPPER, langConfig.getString("item.minecraft.exposed_copper", "Exposed Copper}")));
            itemNames.add(new ItemName(Material.EXPOSED_CUT_COPPER, langConfig.getString("item.minecraft.exposed_cut_copper", "Exposed Cut Copper}")));
            itemNames.add(new ItemName(Material.EXPOSED_CUT_COPPER_SLAB, langConfig.getString("item.minecraft.exposed_cut_copper_slab", "Exposed Cut Copper Slab}")));
            itemNames.add(new ItemName(Material.EXPOSED_CUT_COPPER_STAIRS, langConfig.getString("item.minecraft.exposed_cut_copper_stairs", "Exposed Cut Copper Stairs}")));
            itemNames.add(new ItemName(Material.FLOWERING_AZALEA, langConfig.getString("item.minecraft.flowering_azalea", "Flowering Azalea}")));
            itemNames.add(new ItemName(Material.FLOWERING_AZALEA_LEAVES, langConfig.getString("item.minecraft.flowering_azalea_leaves", "Flowering Azalea Leaves}")));
            ...
            itemNames.add(new ItemName(Material.GLOW_LICHEN, langConfig.getString("item.minecraft.glow_lichen", "Glow Lichen}")));
            ...
            itemNames.add(new ItemName(Material.GRAY_CANDLE, langConfig.getString("item.minecraft.gray_candle", "Gray Candle}")));
            itemNames.add(new ItemName(Material.GRAY_CANDLE_CAKE, langConfig.getString("item.minecraft.gray_candle_cake", "Gray Candle Cake}")));
            itemNames.add(new ItemName(Material.GREEN_CANDLE, langConfig.getString("item.minecraft.green_candle", "Green Candle}")));
            itemNames.add(new ItemName(Material.GREEN_CANDLE_CAKE, langConfig.getString("item.minecraft.green_candle_cake", "Green Candle Cake}")));
            itemNames.add(new ItemName(Material.HANGING_ROOTS, langConfig.getString("item.minecraft.hanging_roots", "Hanging Roots}")));
            itemNames.add(new ItemName(Material.INFESTED_DEEPSLATE, langConfig.getString("item.minecraft.infested_deepslate", "Infested Deepslate}")));
            itemNames.add(new ItemName(Material.LARGE_AMETHYST_BUD, langConfig.getString("item.minecraft.large_amethyst_bud", "Large Amethyst Bud}")));
            itemNames.add(new ItemName(Material.LAVA_CAULDRON, langConfig.getString("item.minecraft.lava_cauldron", "Lava Cauldron}")));
            itemNames.add(new ItemName(Material.LIGHT, langConfig.getString("item.minecraft.light", "Light}")));
            itemNames.add(new ItemName(Material.LIGHT_BLUE_CANDLE, langConfig.getString("item.minecraft.light_blue_candle", "Light Blue Candle}")));
            itemNames.add(new ItemName(Material.LIGHT_BLUE_CANDLE_CAKE, langConfig.getString("item.minecraft.light_blue_candle_cake", "Light Blue Candle Cake}")));
            itemNames.add(new ItemName(Material.LIGHT_GRAY_CANDLE, langConfig.getString("item.minecraft.light_gray_candle", "Light Gray Candle}")));
            itemNames.add(new ItemName(Material.LIGHT_GRAY_CANDLE_CAKE, langConfig.getString("item.minecraft.light_gray_candle_cake", "Light Gray Candle Cake}")));
            itemNames.add(new ItemName(Material.LIGHTNING_ROD, langConfig.getString("item.minecraft.lightning_rod", "Lightning Rod}")));
            itemNames.add(new ItemName(Material.LIME_CANDLE, langConfig.getString("item.minecraft.lime_candle", "Lime Candle}")));
            itemNames.add(new ItemName(Material.LIME_CANDLE_CAKE, langConfig.getString("item.minecraft.lime_candle_cake", "Lime Candle Cake}")));
            itemNames.add(new ItemName(Material.MAGENTA_CANDLE, langConfig.getString("item.minecraft.magenta_candle", "Magenta Candle}")));
            itemNames.add(new ItemName(Material.MAGENTA_CANDLE_CAKE, langConfig.getString("item.minecraft.magenta_candle_cake", "Magenta Candle Cake}")));
            itemNames.add(new ItemName(Material.MEDIUM_AMETHYST_BUD, langConfig.getString("item.minecraft.medium_amethyst_bud", "Medium Amethyst Bud}")));
            itemNames.add(new ItemName(Material.MOSS_BLOCK, langConfig.getString("item.minecraft.moss_block", "Moss Block}")));
            itemNames.add(new ItemName(Material.MOSS_CARPET, langConfig.getString("item.minecraft.moss_carpet", "Moss Carpet}")));
            itemNames.add(new ItemName(Material.ORANGE_CANDLE, langConfig.getString("item.minecraft.orange_candle", "Orange Candle}")));
            itemNames.add(new ItemName(Material.ORANGE_CANDLE_CAKE, langConfig.getString("item.minecraft.orange_candle_cake", "Orange Candle Cake}")));
            itemNames.add(new ItemName(Material.OXIDIZED_COPPER, langConfig.getString("item.minecraft.oxidized_copper", "Oxidized Copper}")));
            itemNames.add(new ItemName(Material.OXIDIZED_CUT_COPPER, langConfig.getString("item.minecraft.oxidized_cut_copper", "Oxidized Cut Copper}")));
            itemNames.add(new ItemName(Material.OXIDIZED_CUT_COPPER_SLAB, langConfig.getString("item.minecraft.oxidized_cut_copper_slab", "Oxidized Cut Copper Slab}")));
            itemNames.add(new ItemName(Material.OXIDIZED_CUT_COPPER_STAIRS, langConfig.getString("item.minecraft.oxidized_cut_copper_stairs", "Oxidized Cut Copper Stairs}")));
            itemNames.add(new ItemName(Material.PIGLIN_BRUTE_SPAWN_EGG, langConfig.getString("item.minecraft.piglin_brute_spawn_egg", "Piglin Brute Spawn Egg}")));
            itemNames.add(new ItemName(Material.PINK_CANDLE, langConfig.getString("item.minecraft.pink_candle", "Pink Candle}")));
            itemNames.add(new ItemName(Material.PINK_CANDLE_CAKE, langConfig.getString("item.minecraft.pink_candle_cake", "Pink Candle Cake}")));
            itemNames.add(new ItemName(Material.POINTED_DRIPSTONE, langConfig.getString("item.minecraft.pointed_dripstone", "Pointed Dripstone}")));
            itemNames.add(new ItemName(Material.POLISHED_DEEPSLATE, langConfig.getString("item.minecraft.polished_deepslate", "Polished Deepslate}")));
            itemNames.add(new ItemName(Material.POLISHED_DEEPSLATE_SLAB, langConfig.getString("item.minecraft.polished_deepslate_slab", "Polished Deepslate Slab}")));
            itemNames.add(new ItemName(Material.POLISHED_DEEPSLATE_STAIRS, langConfig.getString("item.minecraft.polished_deepslate_stairs", "Polished Deepslate Stairs}")));
            itemNames.add(new ItemName(Material.POLISHED_DEEPSLATE_WALL, langConfig.getString("item.minecraft.polished_deepslate_wall", "Polished Deepslate Wall}")));
            itemNames.add(new ItemName(Material.POTTED_AZALEA_BUSH, langConfig.getString("item.minecraft.potted_azalea_bush", "Potted Azalea Bush}")));
            itemNames.add(new ItemName(Material.POTTED_FLOWERING_AZALEA_BUSH, langConfig.getString("item.minecraft.potted_flowering_azalea_bush", "Potted Flowering Azalea Bush}")));
            itemNames.add(new ItemName(Material.POWDER_SNOW, langConfig.getString("item.minecraft.powder_snow", "Powder Snow}")));
            ...
            itemNames.add(new ItemName(Material.POWDER_SNOW_CAULDRON, langConfig.getString("item.minecraft.powder_snow_cauldron", "Powder Snow Cauldron}")));
            itemNames.add(new ItemName(Material.PURPLE_CANDLE, langConfig.getString("item.minecraft.purple_candle", "Purple Candle}")));
            itemNames.add(new ItemName(Material.PURPLE_CANDLE_CAKE, langConfig.getString("item.minecraft.purple_candle_cake", "Purple Candle Cake}")));
            itemNames.add(new ItemName(Material.RAW_COPPER, langConfig.getString("item.minecraft.raw_copper", "Raw Copper}")));
            itemNames.add(new ItemName(Material.RAW_COPPER_BLOCK, langConfig.getString("item.minecraft.raw_copper_block", "Raw Copper Block}")));
            itemNames.add(new ItemName(Material.RAW_GOLD, langConfig.getString("item.minecraft.raw_gold", "Raw Gold}")));
            itemNames.add(new ItemName(Material.RAW_GOLD_BLOCK, langConfig.getString("item.minecraft.raw_gold_block", "Raw Gold Block}")));
            itemNames.add(new ItemName(Material.RAW_IRON, langConfig.getString("item.minecraft.raw_iron", "Raw Iron}")));
            itemNames.add(new ItemName(Material.RAW_IRON_BLOCK, langConfig.getString("item.minecraft.raw_iron_block", "Raw Iron Block}")));
            itemNames.add(new ItemName(Material.RED_CANDLE, langConfig.getString("item.minecraft.red_candle", "Red Candle}")));
            itemNames.add(new ItemName(Material.RED_CANDLE_CAKE, langConfig.getString("item.minecraft.red_candle_cake", "Red Candle Cake}")));
            itemNames.add(new ItemName(Material.ROOTED_DIRT, langConfig.getString("item.minecraft.rooted_dirt", "Rooted Dirt}")));
            itemNames.add(new ItemName(Material.SCULK_SENSOR, langConfig.getString("item.minecraft.sculk_sensor", "Sculk Sensor}")));
            itemNames.add(new ItemName(Material.SMALL_AMETHYST_BUD, langConfig.getString("item.minecraft.small_amethyst_bud", "Small Amethyst Bud}")));
            itemNames.add(new ItemName(Material.SMALL_DRIPLEAF, langConfig.getString("item.minecraft.small_dripleaf", "Small Dripleaf}")));
            itemNames.add(new ItemName(Material.SMOOTH_BASALT, langConfig.getString("item.minecraft.smooth_basalt", "Smooth Basalt}")));
            itemNames.add(new ItemName(Material.SPORE_BLOSSOM, langConfig.getString("item.minecraft.spore_blossom", "Spore Blossom}")));
            itemNames.add(new ItemName(Material.SPYGLASS, langConfig.getString("item.minecraft.spyglass", "Spyglass}")));
            itemNames.add(new ItemName(Material.TINTED_GLASS, langConfig.getString("item.minecraft.tinted_glass", "Tinted Glass}")));
            itemNames.add(new ItemName(Material.TUFF, langConfig.getString("item.minecraft.tuff", "Tuff}")));
            itemNames.add(new ItemName(Material.WATER_CAULDRON, langConfig.getString("item.minecraft.water_cauldron", "Water Cauldron}")));
            itemNames.add(new ItemName(Material.WAXED_COPPER_BLOCK, langConfig.getString("item.minecraft.waxed_copper_block", "Waxed Copper Block}")));
            itemNames.add(new ItemName(Material.WAXED_CUT_COPPER, langConfig.getString("item.minecraft.waxed_cut_copper", "Waxed Cut Copper}")));
            itemNames.add(new ItemName(Material.WAXED_CUT_COPPER_SLAB, langConfig.getString("item.minecraft.waxed_cut_copper_slab", "Waxed Cut Copper Slab}")));
            itemNames.add(new ItemName(Material.WAXED_CUT_COPPER_STAIRS, langConfig.getString("item.minecraft.waxed_cut_copper_stairs", "Waxed Cut Copper Stairs}")));
            itemNames.add(new ItemName(Material.WAXED_EXPOSED_COPPER, langConfig.getString("item.minecraft.waxed_exposed_copper", "Waxed Exposed Copper}")));
            itemNames.add(new ItemName(Material.WAXED_EXPOSED_CUT_COPPER, langConfig.getString("item.minecraft.waxed_exposed_cut_copper", "Waxed Exposed Cut Copper}")));
            itemNames.add(new ItemName(Material.WAXED_EXPOSED_CUT_COPPER_SLAB, langConfig.getString("item.minecraft.waxed_exposed_cut_copper_slab", "Waxed Exposed Cut Copper Slab}")));
            itemNames.add(new ItemName(Material.WAXED_EXPOSED_CUT_COPPER_STAIRS, langConfig.getString("item.minecraft.waxed_exposed_cut_copper_stairs", "Waxed Exposed Cut Copper Stairs}")));
            itemNames.add(new ItemName(Material.WAXED_OXIDIZED_COPPER, langConfig.getString("item.minecraft.waxed_oxidized_copper", "Waxed Oxidized Copper}")));
            itemNames.add(new ItemName(Material.WAXED_OXIDIZED_CUT_COPPER, langConfig.getString("item.minecraft.waxed_oxidized_cut_copper", "Waxed Oxidized Cut Copper}")));
            itemNames.add(new ItemName(Material.WAXED_OXIDIZED_CUT_COPPER_SLAB, langConfig.getString("item.minecraft.waxed_oxidized_cut_copper_slab", "Waxed Oxidized Cut Copper Slab}")));
            itemNames.add(new ItemName(Material.WAXED_OXIDIZED_CUT_COPPER_STAIRS, langConfig.getString("item.minecraft.waxed_oxidized_cut_copper_stairs", "Waxed Oxidized Cut Copper Stairs}")));
            itemNames.add(new ItemName(Material.WAXED_WEATHERED_COPPER, langConfig.getString("item.minecraft.waxed_weathered_copper", "Waxed Weathered Copper}")));
            itemNames.add(new ItemName(Material.WAXED_WEATHERED_CUT_COPPER, langConfig.getString("item.minecraft.waxed_weathered_cut_copper", "Waxed Weathered Cut Copper}")));
            itemNames.add(new ItemName(Material.WAXED_WEATHERED_CUT_COPPER_SLAB, langConfig.getString("item.minecraft.waxed_weathered_cut_copper_slab", "Waxed Weathered Cut Copper Slab}")));
            itemNames.add(new ItemName(Material.WAXED_WEATHERED_CUT_COPPER_STAIRS, langConfig.getString("item.minecraft.waxed_weathered_cut_copper_stairs", "Waxed Weathered Cut Copper Stairs}")));
            itemNames.add(new ItemName(Material.WEATHERED_COPPER, langConfig.getString("item.minecraft.weathered_copper", "Weathered Copper}")));
            itemNames.add(new ItemName(Material.WEATHERED_CUT_COPPER, langConfig.getString("item.minecraft.weathered_cut_copper", "Weathered Cut Copper}")));
            itemNames.add(new ItemName(Material.WEATHERED_CUT_COPPER_SLAB, langConfig.getString("item.minecraft.weathered_cut_copper_slab", "Weathered Cut Copper Slab}")));
            itemNames.add(new ItemName(Material.WEATHERED_CUT_COPPER_STAIRS, langConfig.getString("item.minecraft.weathered_cut_copper_stairs", "Weathered Cut Copper Stairs}")));
            itemNames.add(new ItemName(Material.WHITE_CANDLE, langConfig.getString("item.minecraft.white_candle", "White Candle}")));
            itemNames.add(new ItemName(Material.WHITE_CANDLE_CAKE, langConfig.getString("item.minecraft.white_candle_cake", "White Candle Cake}")));
            itemNames.add(new ItemName(Material.YELLOW_CANDLE, langConfig.getString("item.minecraft.yellow_candle", "Yellow Candle}")));
            itemNames.add(new ItemName(Material.YELLOW_CANDLE_CAKE, langConfig.getString("item.minecraft.yellow_candle_cake", "Yellow Candle Cake}")));
        } else {
